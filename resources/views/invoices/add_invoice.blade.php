...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Add Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                Invoices</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="please enter the number of invoice" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="" selected disabled>chose the categorie</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">VAT ratio</label>
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled>Value tax ratio</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Total tax inclusive </label>
                        ...
                        <p class="text-danger">* Annex formula pdf, jpeg ,.jpg , png </p>
                        <h5 class="card-title">annexes</h5>
